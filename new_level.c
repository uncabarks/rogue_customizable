...
#define TREAS_ROOM 5	/* one chance in TREAS_ROOM for a treasure room */
#define MAXTREAS 20	/* maximum number of treasures in a treasure room */
#define MINTREAS 8	/* minimum number of treasures in a treasure room */
