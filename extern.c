...
{ "dragon",	 100,	ISMEAN,	{ XX,500, 10,  -1, ___, "1x6/1x6/2x3" } },
...
{ "griffin",	  20,	ISMEAN|ISFLY|ISREGEN, { XX,200, 13,   2, ___, "2x5/1x7" } },
{ "hobgoblin",	   0,	ISMEAN,	{ XX,  3,   1,   5, ___, "1x8" } },
{ "ice monster",   0,	0,	{ XX,  5,   1,   9, ___, "0x0" } },
{ "jabberwock",   70,	0,	{ XX, 300, 15,   6, ___, "2x5/1x4" } },
{ "kestrel",	   0,	ISMEAN|ISFLY,	{ XX,  1,   1,   7, ___, "1x4" } },
{ "leprechaun",	   0,	0,	{ XX, 10,   3,   8, ___, "1x1" } },
{ "medusa",	  40,	ISMEAN,	{ XX, 200,   8,   2, ___, "1x4/1x4/2x2" } },
{ "nymph",	 100,	0,	{ XX, 37,   3,   9, ___, "0x0" } },
{ "orc",	  15,	ISGREED,{ XX,  5,   1,   6, ___, "1x8" } },
{ "phantom",	   0,	ISINVIS,{ XX, 80,   8,   3, ___, "4x1" } },
{ "quagga",	   0,	ISMEAN,	{ XX, 15,   3,   3, ___, "1x5/1x5" } },
{ "rattlesnake",   0,	ISMEAN,	{ XX,  9,   2,   3, ___, "1x6" } },
{ "snake",	   0,	ISMEAN,	{ XX,  2,   1,   5, ___, "1x3" } },
{ "troll",	  50,	ISREGEN|ISMEAN,{ XX, 120, 6, 4, ___, "1x3/1x3/2x1" } },
{ "black unicorn", 0,	ISMEAN,	{ XX, 90,   7,  -2, ___, "1x6/1x6/2x6" } },
{ "vampire",	  20,	ISREGEN|ISMEAN,{ XX,350,   8,   1, ___, "1x5" } },
{ "wraith",	   0,	0,	{ XX, 55,   5,   4, ___, "1x6" } },
{ "xeroc",	  30,	0,	{ XX, 75,   7,   7, ___, "3x4" } },
{ "yeti",	  30,	0,	{ XX, 50,   4,   6, ___, "1x5/1x5" } },
{ "zombie",	   0,	ISMEAN,	{ XX,  6,   2,   8, ___, "1x3" } }
    };
#undef ___
#undef XX
...
struct obj_info pot_info[MAXPOTIONS] = {
    { "confusion",		 3,   5, NULL, FALSE },
    { "hallucination",		 4,   5, NULL, FALSE },
    { "poison",			 3,   5, NULL, FALSE },
    { "gain strength",		18, 150, NULL, FALSE },
    { "see invisible",		 7, 100, NULL, FALSE },
    { "healing",		20, 130, NULL, FALSE },
    { "monster detection",	 15, 130, NULL, FALSE },
    { "magic detection",	 15, 105, NULL, FALSE },
    { "raise level",		 15, 250, NULL, FALSE },
    { "extra healing",		 9, 200, NULL, FALSE },
    { "haste self",		 5, 190, NULL, FALSE },
    { "restore strength",	20, 130, NULL, FALSE },
    { "blindness",		 1,   5, NULL, FALSE },
    { "levitation",		 8,  75, NULL, FALSE },
};
struct obj_info ring_info[MAXRINGS] = {
    { "protection",		 12, 400, NULL, FALSE },
    { "add strength",		 12, 400, NULL, FALSE },
    { "sustain strength",	 10, 280, NULL, FALSE },
    { "searching",		15, 420, NULL, FALSE },
    { "see invisible",		10, 310, NULL, FALSE },
    { "adornment",		 1,  10, NULL, FALSE },
    { "aggravate monster",	1,  10, NULL, FALSE },
    { "dexterity",		 15, 440, NULL, FALSE },
    { "increase damage",	 8, 400, NULL, FALSE },
    { "regeneration",		 12, 460, NULL, FALSE },
    { "slow digestion",		 30, 240, NULL, FALSE },
    { "teleportation",		 5,  30, NULL, FALSE },
    { "stealth",		 7, 470, NULL, FALSE },
    { "maintain armor",		 5, 380, NULL, FALSE },
};
struct obj_info scr_info[MAXSCROLLS] = {
    { "monster confusion",		 5, 140, NULL, FALSE },
    { "magic mapping",			 5, 150, NULL, FALSE },
    { "hold monster",			 2, 180, NULL, FALSE },
    { "sleep",				 3,   5, NULL, FALSE },
    { "enchant armor",			 50, 160, NULL, FALSE },
    { "identify potion",		30,  80, NULL, FALSE },
    { "identify scroll",		30,  80, NULL, FALSE },
    { "identify weapon",		 30,  80, NULL, FALSE },
    { "identify armor",		 	 30, 100, NULL, FALSE },
    { "identify ring, wand or staff",	30, 115, NULL, FALSE },
    { "scare monster",			 3, 200, NULL, FALSE },
    { "food detection",			 6,  60, NULL, FALSE },
    { "teleportation",			 5, 165, NULL, FALSE },
    { "enchant weapon",			 50, 150, NULL, FALSE },
    { "create monster",			 1,  75, NULL, FALSE },
    { "remove curse",			 30, 105, NULL, FALSE },
    { "aggravate monsters",		 1,  20, NULL, FALSE },
    { "protect armor",			 2, 250, NULL, FALSE },
};
struct obj_info weap_info[MAXWEAPONS + 1] = {
    { "mace",				4,   8, NULL, FALSE },
    { "long sword",			9,  15, NULL, FALSE },
    { "short bow",			4,  15, NULL, FALSE },
    { "arrow",				4,   1, NULL, FALSE },
    { "dagger",				2,   3, NULL, FALSE },
    { "two handed sword",	7,  75, NULL, FALSE },
...
struct obj_info ws_info[MAXSTICKS] = {
    ...
    { "invisibility",		 8,   5, NULL, FALSE },
    { "lightning",		 3, 330, NULL, FALSE },
    { "fire",			 3, 330, NULL, FALSE },
    { "cold",			 , 330, NULL, FALSE },
    { "polymorph",		30, 310, NULL, FALSE },
    { "magic missile",	15, 170, NULL, FALSE },
    { "haste monster",		3,   5, NULL, FALSE },
    { "slow monster",		15, 350, NULL, FALSE },
    { "drain life",		 9, 300, NULL, FALSE },
    { "nothing",		 1,   5, NULL, FALSE },
    { "teleport away",		9, 340, NULL, FALSE },
    { "teleport to",		 7,  50, NULL, FALSE },
